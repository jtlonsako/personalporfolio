...
export default function HeroPage() {
  ...
  return (
    <div className="grid md:grid-cols-2 justify-items-center space-y-14">
        <div className={`${inter.className} grid justify-center md:justify-start text-left place-content-center space-y-5`}>
            <p className="text-4xl">Hello! I am</p>
            <p className="text-7xl text-green-600 md:-ml-2">Joshua Lonsako</p>
            ...
            <div style={{marginTop: '2rem'}} className="flex justify-center md:justify-start">
